...
# =============================================================================
# CONSTANTES GLOBAIS (CORRIGIDO: Evita KeyError no formulário)
# =============================================================================
CATEGORIAS_MAP = {
...
# Lembre-se de substituir os valores '0' pelas pontuações reais caso existam!
PONTUACOES_MAX = {
    # 1. Infraestrutura e Setor
    "1.0": 30, "1.1": 30, "1.2": 30, "1.3": 30, "1.3.1": 30, "1.4": 0, "1.4.1": 40, "1.4.2": 20,
    
    # 2. Planejamento (PDTIC)
    "2.0": 40, "2.1": 20, "2.2": 40, "2.3": 20,
    
    # 3. Segurança da Informação
    "3.0": 50, "3.1": 0, "3.1.1": 40, "3.1.1.1": 10, "3.2": 0, "3.2.1": 10, "3.3": 30, "3.4": 30, "3.5": 30, "3.6": 20, "3.6.1": 0,
    
    # 4. Transparência / 6.0 / 7.0
    "4.0": 40, "4.1": 0, "4.2": 0, 
    "6.0": 20, "6.1": 20, "6.2": 20, "6.3": 10, "6.4": 30, 
    "7.0": 25, "7.1": 10, "7.2": 10, "7.3": 5,
    
    # 5. Governo Digital / 9.0
    ...
    # 10. LGPD / 11.0
    "10.0": 0, "10.1": 0, "10.2": 0, "10.3": 0, "10.4": 0, "10.5": 0, "10.5.1": 0, 
    "11.0": 0, "11.1": 0
}
